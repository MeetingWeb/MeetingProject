...
public class StringUtil {
	 ...
	 *
	 * StringUtil.remove(null, *) = null StringUtil.remove("", *) = ""
	 * StringUtil.remove("queued", 'u') = "qeed" StringUtil.remove("queued",
	 * 'z') = "queued"
	 *
	 * @param str
	 *            입력받는 기준 문자열
	 ...
	 *
	 * StringUtil.removeCommaChar(null) = null StringUtil.removeCommaChar("") =
	 ...
	 *
	 * StringUtil.removeMinusChar(null) = null StringUtil.removeMinusChar("") =
	 ...
	 *
	 * StringUtil.indexOf(null, *) = -1 StringUtil.indexOf(*, null) = -1
	 * StringUtil.indexOf("", "") = 0 StringUtil.indexOf("aabaabaa", "a") = 0
	 * StringUtil.indexOf("aabaabaa", "b") = 2 StringUtil.indexOf("aabaabaa",
	 * "ab") = 1 StringUtil.indexOf("aabaabaa", "") = 0
	 *
	 * @param str
	 *            검색 문자열
	 * @param searchStr
	...
	/**
	 * 오라클의 decode 함수와 동일한 기능을 가진 메서드이다. sourStr과 compareStr의 값이 같으면 returStr을
	 * 반환하며, 다르면 defaultStr을 반환한다.
	 *
	 * StringUtil.decode(null, null, "foo", "bar")= "foo" StringUtil.decode("",
	 * null, "foo", "bar") = "bar" StringUtil.decode(null, "", "foo", "bar") =
	 * "bar" StringUtil.decode("하이", "하이", null, "bar") = null
	...
	/**
	 * 오라클의 decode 함수와 동일한 기능을 가진 메서드이다. sourStr과 compareStr의 값이 같으면 returStr을
	 * 반환하며, 다르면 sourceStr을 반환한다.
	 *
	 * StringUtil.decode(null, null, "foo") = "foo" StringUtil.decode("", null,
	 * "foo") = "" StringUtil.decode(null, "", "foo") = null
	 * StringUtil.decode("하이", "하이", "foo") = "foo" StringUtil.decode("하이",
	 * "하이 ", "foo") = "하이" StringUtil.decode("하이", "바이", "foo") = "하이"
	 *
	 * @param sourceStr
	 *            비교할 문자열
	 * @param compareStr
	...
	/**
	 * 인자로 받은 String이 null일 경우 &quot;&quot;로 리턴한다. &#064;param src null값일 가능성이
	 * 있는 String 값. &#064;return 만약 String이 null 값일 경우 &quot;&quot;로 바꾼 String
	 * 값.
	 */
	...
	/**
	 * 인자로 받은 String이 null일 경우 &quot;0&quot;로 리턴한다. &#064;param src null값일 가능성이
	 * 있는 String 값. &#064;return 만약 String이 null 값일 경우 &quot;0&quot;로 바꾼 String
	 * 값.
	 */
	 ...
	 *
	 * StringUtil.removeWhitespace(null) = null StringUtil.removeWhitespace("")
	 ...
	 *
	 * StringUtil.lowerCase(null) = null StringUtil.lowerCase("") = ""
	 ...
	 *
	 * StringUtil.upperCase(null) = null StringUtil.upperCase("") = ""
	 ...
	 * StringUtil.stripStart("abc", "") = "abc" StringUtil.stripStart("abc",
	 * null) = "abc" StringUtil.stripStart("  abc", null) = "abc"
	 * StringUtil.stripStart("abc  ", null) = "abc  " StringUtil.stripStart(
	 * " abc ", null) = "abc " StringUtil.stripStart("yxabc  ", "xyz") = "abc  "
	 *
	 * @param str
	 *            지정된 문자가 제거되어야 할 문자열
	 * @param stripChars
	 ...
	 * StringUtil.stripEnd("abc", "") = "abc" StringUtil.stripEnd("abc", null) =
	 * "abc" StringUtil.stripEnd("  abc", null) = "  abc" StringUtil.stripEnd(
	 * "abc  ", null) = "abc" StringUtil.stripEnd(" abc ", null) = " abc"
	 ...
	 * StringUtil.strip("abc", null) = "abc" StringUtil.strip("  abc", null) =
	 * "abc" StringUtil.strip("abc  ", null) = "abc" StringUtil.strip(" abc ",
	 * null) = "abc" StringUtil.strip("  abcyx", "xyz") = "  abc"
	 *
	 * @param str
	 *            지정된 문자가 제거되어야 할 문자열
	 * @param stripChars
